...
('bobwalker', 'bob@example.com', 'hashed123', 'walker'),
('carol123', 'carol@example.com', 'hashed123', 'owner'),
('jarrydwong', 'jarryd@example.com', 'hashed123', 'walker'),
('veronica123', 'veronica@example.com', 'hashed123', 'owner');
...
((SELECT dog_id FROM Dogs WHERE name = 'Pacup'), '2025-06-10 08:00:00', '30', 'Parklands', 'open'),
((SELECT dog_id FROM Dogs WHERE name = 'Paris'), '2025-06-10 08:00:00', '30', 'Parklands', 'open'),
((SELECT dog_id FROM Dogs WHERE name = 'Doggo'), '2025-06-10 08:00:00', '60', 'Parklands', 'completed');