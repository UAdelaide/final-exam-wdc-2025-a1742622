...
((SELECT dog_id FROM Dogs WHERE name = 'Pacup'), '2025-06-10 10:30:00', '45', 'Parklands', 'open'),
((SELECT dog_id FROM Dogs WHERE name = 'Paris'), '2025-06-10 09:30:00', '45', 'Parklands', 'open'),
((SELECT dog_id FROM Dogs WHERE name = 'Doggo'), '2025-06-08 08:00:00', '60', 'SomeBeach', 'completed');